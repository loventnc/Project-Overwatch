    ...
    <>
      ...
      <div className="bg-cover bg-center bg-BGHeader h-[660px] ">
        <div className="ml-32 pt-72">
          <h1 className="hidden lg:grid text-white text-[50px] font-bold ">
            HEROES
          </h1>
        </div>
      </div>
      ...
      <div className="bg-[#DDF2FD]">
        <div className="flex flex-col items-center pt-10">
          ...
          <div className="pt-10">
            <h4 className="flex justify-center text-center text-[18px]">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Overwatch features an
              international cast of powerful heroes with captivating
        ...
        <div className="flex justify-center items-center ">
          <div className="lg:grid xl:grid-cols-6 flex flex-wrap justify-center gap-14 p-10 ">
            {Heroesin.map((hero, index) => (
              <div
                key={index}
                className="bg-white h-1/4 w-1/4 lg:h-[220px] lg:w-[180px] rounded-none text-center border-4 border-white hover:scale-110 transition duration-50 hover:shadow-2xl"
              >
                <a
                ...
                >
                  <img
                    ...
                    width="180px"
                  />
                  <h1 className="flex justify-center items-center pt-2 text-[18px] font-medium">
                    {hero.name}
                  </h1>
                </a>
              </div>
